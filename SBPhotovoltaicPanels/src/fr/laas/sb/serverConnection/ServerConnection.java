...
public class ServerConnection {
	...
	private static Hashtable<String,Message> msgList=new Hashtable<String,Message>() {{
		put("areYouAlivePhotovoltaicPanel",new Alive());
	...
	public ServerConnection(String configFile)
	{
		...
		//verify file reading
		System.out.println("");
		System.out.println("**************** PhotovoltaicPanel entity ******************");
		System.out.println("");
		...
		this.sendToBuildingManager("PhotovoltaicPanelConnected");
		//send the ip adress to the building manager
				this.sendToBuildingManager("ipPanel"+chatClient.getServer());
	}
