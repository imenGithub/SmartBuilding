...
import fr.laas.sb.messages.StateChange;
...
public class ServerConnection {
	...
	private Vector<String> messages; //contains all the messages received by the photovoltaicPanel
	...
	private static Hashtable<String,Message> msgList=new Hashtable<String,Message>() {{
		...
		put("stateChangeOn",new StateChange("on"));

		
		put("areYouAliveSmartPlug",new Alive());
...
//		put("sending",  new SendingChange());
	...
	public ServerConnection(String configFile)
	{
		...
		//verify file reading
		System.out.println("");
		System.out.println("**************** SmartPlug entity ******************");
		System.out.println("");
		...
		this.sendToBuildingManager("SmartPlugConnected");
		//send the ip adress to the building manager
		this.sendToBuildingManager("ipSmartPlug"+chatClient.getServer());
	}
