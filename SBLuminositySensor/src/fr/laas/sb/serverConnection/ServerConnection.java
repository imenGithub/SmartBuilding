...
public class ServerConnection {
	...
	public ServerConnection(String configFile)
	{
		...
		//verify file reading
		System.out.println("");
		System.out.println("**************** LuminositySensor entity ******************");
		System.out.println("");
		...
		System.out.println("*******************************************************");
		this.setUser(chatClient.getUser());
		receiverUserVector = new Vector<String>();
		receiverUserVector.addElement("BuildingManager");
		
		
		this.sendToBuildingManager("LuminositySensorConnected");
		//send the ip adress to the building manager
				//this.sendToBuildingManager("ipTh"+chatClient.getServer());
	}
	...
	public String receiveNewMessage()
	{
		...
		//System.out.print("New message received by the thermometer : ");
